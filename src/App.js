...
import OrderWaiting from './screens/OrderWaiting/OrderWaiting';
import OrderSucces from './screens/OrderSucces/OrderSucces';
import './App.css';
        ...
        >
          <Router>
            ...
            <Switch>
              ...
              <Route path="/orderwaiting">
                <OrderWaiting />
              </Route>
              <Route path="/ordersucces">
                <OrderSucces />
              </Route>
              <Route path="/register">
                <Register
